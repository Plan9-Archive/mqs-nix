...
struct VGAscr {
	...
	uint	id;	/* internal identifier for driver use */
	int	isblank;
	int	overlayinit;
};
...
extern	void	addvgaseg(char*, uintmem, usize);
...
extern	void	vgalinearaddr(VGAscr*, uintmem, int);
