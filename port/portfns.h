...
int		haswaitq(void*);
void		hnputl(void*, u32int);
void		hnputs(void*, u16int);
void		hnputv(void*, u64int);
...
uvlong		ms2fastticks(uint);
#define		MS2NS(n) (((vlong)(n))*1000000LL)
#define		MS2TK(m)	(((m)*HZ)/1000)
ulong		ms2tk(ulong);
